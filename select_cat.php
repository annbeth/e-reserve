...
<tr>
<td>
    <select name="category" id="category" style="height:130%;" class="browser-default">
<option value="default">Select</option>

<?php
$cat="SELECT category_id,category_name FROM category WHERE hotel_code=$code;";
$que_cat=mysqli_query($conn,$cat);
while($rows=mysqli_fetch_array($que_cat))
{
$cat=$rows['category_id'];
?>
<option value="<?php echo $cat;?>"><?php echo $rows['category_name'];?></option>
<?php
}
?>
</select>
